...
- **Server Components First**: Maximum performance and minimal client bundle overhead by defaulting to React Server Components.
- **Accessible & Semantic HTML**: Strict adherence to semantic elements and ARIA standards.
- **Clean & Modular Architecture**: Decoupled, single-purpose components with explicit TypeScript interfaces.
- **Conventional Commits**: Standardized git commit history following the [Conventional Commits](https://www.conventionalcommits.org/) specification.
...
This project is licensed under the MIT License - see the [LICENSE](file:///Users/lalmanchaudhary/Desktop/capstones/FE-01/LICENSE) file for details.
